                    ...
                    <nav class="menu-block" id="append-menu-header">
                        ...
                        <ul class="site-menu-main">
                            <li class="nav-item nav-item-has-children">
                                <a href="#" class="nav-link-item drop-trigger">Demos <i
                                        class="fas fa-angle-down"></i></a>
                                <ul class="sub-menu" id="submenu-1">
                                    <li class="sub-menu--item nav-item-has-children">
                                        <a href="#" data-menu-get="h3" class="drop-trigger">Multipage<i
                                    ...
                                    <li class="sub-menu--item nav-item-has-children">
                                        <a href="#" data-menu-get="h3" class="drop-trigger">OnePage <i
                                                class="fas fa-angle-down"></i></a>
                            ...
                            <li class="nav-item nav-item-has-children">
                                ...
                                <ul class="sub-menu" id="submenu-4">
                                    ...
                                    <li class="sub-menu--item nav-item-has-children">
                                        <a href="#" data-menu-get="h3" class="drop-trigger">Career<i
                                                class="fas fa-angle-down"></i>
                                        </a>
                    ...
                    <div class="sofax-iconbox-wrap wow fadeInUpX" data-wow-delay="0.1s">
                        ...
                        <div class="sofax-iconbox-data">
                            ...
                            <a class='sofax-icon-btn' href='single-service.html'>More details <img
                                    src="{{ asset('frontend/assets/images/v1/arrow-right.png') }}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="extra-mt">
                            <div class="sofax-iconbox-wrap2">
                                <div class="sofax-iconbox-icon2">
                                    <img src="{{ asset('frontend/assets/images/v1/check-circle.png') }}"
                                        alt="">
                                </div>
                        ...
                        <div class="sofax-pricing-body">
                            ...
                            <ul>
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">Lead, deal, contact, calendar
                                    and pipeline management</li>
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">Seamless data import and 400+
                                    integrations</li>
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">24/7, multi-language support
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="sofax-pricing-wrap wow fadeInUpX active" data-wow-delay="0.1s">
                        ...
                        <div class="sofax-pricing-body">
                            ...
                            <ul>
                                ...
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">Meeting, email and video call
                                </li>
                            </ul>
                        </div>
                        <div class="sofax-pricing-footer">
                    ...
                    <div class="sofax-pricing-wrap wow fadeInUpX" data-wow-delay="0.1s">
                        ...
                        <div class="sofax-pricing-body">
                            ...
                            <ul>
                                ...
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">Document and contract
                                    management with e-signatures</li>
                                <li><img src="{{ asset('frontend/assets/images/v1/icon8.png') }}"
                                        alt="">Revenue forecasts & reporting
                                </li>
                            </ul>
                        </div>
                        <div class="sofax-pricing-footer">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="sofax-default-content tac light-color">
                        ...
                        <div class="extra-mt wow fadeInUpX">
                            <a class='sofax-default-btn pill' data-text='View all integrations'
                                href='contact-us.html'>
